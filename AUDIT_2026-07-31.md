...
1. **Correggere CRT (20 celle) + snapshot test** — cambia gli esiti di quasi ogni combattimento.
2. **Correggere le 7 righe della tabella meteo** — cambia interi scenari invernali.
3. **Costo 2 MP per città/forte nemico + negazione del beneficio ferrovia in attacco** — oggi gli assedi costano troppo poco.
4. **Fix logica EZOC (stessa unità vs unità diverse) e marker No EZOC.**
5. **Airdrop secondo regola (−2 difensore + presa città 1-3), ritorni Tanks/Jets a 1 turno, strait +2 MP.**
6. **Vittoria France 1940/41 con Belgio+Olanda; condizioni di vittoria per Barbarossa/Russia (fan-made).**
7. Vincolo nazionalità Air Support, bomber −2 in difesa, retreat in hex con fort, LSS cap 2.
8. Pulizia dead code + README onesto; build Electron senza rsync.
